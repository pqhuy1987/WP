...
class single_category_posts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			sprintf( __('%sCategory Posts', 'splash' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
			array( 'description' => __( 'Display the most recent posts from a single category', 'splash' ) )
		);
	}
 	...
 	public function form( $instance ) {
		...
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Featured Category', 'splash' );
				...
				<div class="post-data">
					<div class="post-data-container">
						...
						<div class="post-info">
							...
							<span class="thecomment"><?php echo comments_number(__('No Comment','splash'), __('One Comment','splash'), '<span class="comm">%</span> '.__('Comments','splash'));?></span>
							<?php endif; ?>
						</div><!--.post-info-->
						<?php endif; ?>
