<?php if (comments_open() || have_comments()) : ?>
    ...
    <div id="comments" class="uk-margin itemComments">
                ...
                <?php else : ?>
                    ...
                    <form class="uk-form" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
                        ...
                        <div class="uk-grid" data-uk-grid>
                            <div class="uk-width-medium-1-3 uk-width-small-1-1 uk-margin-bottom <?php if ($req) echo "required"; ?>">
                                <input type="text" name="author" placeholder="<?php _e('Name', 'warp'); ?> <?php if ($req) echo "*"; ?>" value="<?php echo esc_attr(@$comment_author); ?>" <?php if ($req) echo "aria-required='true'"; ?> required>
                            </div>

                            <div class="uk-width-medium-1-3 uk-width-small-1-1 uk-margin-bottom <?php if ($req) echo "required"; ?>">
                                <input type="text" name="email" placeholder="<?php _e('E-mail', 'warp'); ?> <?php if ($req) echo "*"; ?>" value="<?php echo esc_attr(@$comment_author_email); ?>" <?php if ($req) echo "aria-required='true'"; ?> required>
                            </div>
                        ...
                        <div class="uk-form-row">
                            <textarea name="comment" id="comment" cols="107" rows="6" tabindex="4" placeholder="Message *" required></textarea>
                        </div>

                        <div class="uk-form-row actions uk-margin-large-bottom">
                            <button class="readon" name="submit" type="submit" id="submit" tabindex="5"><?php _e('Submit Comment', 'warp'); ?></button>
