...
// Enable carousels
	jQuery('.bdt-owl-carousel').each(function () {
		// Prepare data
		var $carousel = $(this),
			$slides = $carousel.find('.bdt-carousel-slides'),
			data = $carousel.data();
		...
		var $owlCarousel = $slides.owlCarousel({
			...
			mouseDrag: true,
			autoplayTimeout: data.delay,
			smartSpeed: data.speed,
			lazyLoad: (data.lazyload) ? true : false,
			autoplay: (data.autoplay) ? true : false,
			autoplayHoverPause: (data.hoverpause) ? true : false,
