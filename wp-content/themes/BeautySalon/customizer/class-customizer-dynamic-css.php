 ...
 * in a way that we have a custom data type `beautysalon_Customizer_Dynamic_CSS` which is capable
 * of dynamically generate the CSS out from the provided array `$css_map`.
 */

if ( class_exists( 'WP_Customize_Setting' ) && ! class_exists( 'beautysalon_Customizer_Dynamic_CSS' ) ) {
	class beautysalon_Customizer_Dynamic_CSS extends WP_Customize_Setting {
		/**
