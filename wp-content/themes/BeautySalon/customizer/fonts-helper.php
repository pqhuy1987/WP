 ...
 * @since Total 1.0.0
 */
function beautysalon_standard_fonts() {
	return apply_filters( 'beautysalon_standard_fonts_array', array(
 ...
 * @since 2.1.0
 */
function beautysalon_enqueue_google_font( $font) {

	// Get list of all Google Fonts
	$google_fonts = beautysalon_google_fonts_array();
	...
	// Subset
	$subset = beautysalon_get_mod( 'google_font_subsets', 'latin' );
	$subset = $subset ? $subset : 'latin';
	$subset = '&amp;subset='. $subset;

	// Weights
	$weights = array( '100', '200', '300', '400', '500', '600', '700', '800', '900' );
	$weights = apply_filters( 'beautysalon_google_font_enqueue_weights', $weights, $font );
	$italics = apply_filters( 'beautysalon_google_font_enqueue_italics', true );

	// Main URL
	$url = beautysalon_get_google_fonts_url() .'/css?family='. str_replace(' ', '%20', $font ) .':';
